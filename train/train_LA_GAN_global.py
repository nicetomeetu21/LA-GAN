...
class DEGAN(nn.Module):
    def __init__(self, opt):
        ...
        self.opt = opt
        self.netG = networks.define_G(3, 1, 32, 'global',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_name', type=str, default='global_[1]')
    # training option
    ...
    parser.add_argument('--train_folds', nargs='+', type=int, default=[])
    ...
    train_dataset = AugmentedDataset(opt.A_dir, opt.B_dir, opt.C_dir, opt.D_dir, train_transform)
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, shuffle=True, num_workers=opt.num_workers)
    test_dataset = AugmentedDataset(opt.A_dir, opt.B_dir, opt.C_dir, opt.D_dir, test_transform)
